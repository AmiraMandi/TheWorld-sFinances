...
export const TermsandConditions = () => {
  return (
    <div>
      ...
      <p>Welcome to World's Finances!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of World's Finances's Website, located at
        https://3000-amiramandi-theworldsfin-tct6o3g5z63.ws-eu93.gitpod.io/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use World's Finances if you do not agree
      ...
      <p>
        ...
        subject to, prevailing law of es. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing World's Finances, you agreed
        to use cookies in agreement with the World's Finances's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, World's Finances and/or its licensors own the
        intellectual property rights for all material on World's Finances. All
        intellectual property rights are reserved. You may access this from
        World's Finances for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from World's Finances</li>
        <li>Sell, rent or sub-license material from World's Finances</li>
        <li>Reproduce, duplicate or copy material from World's Finances</li>
        <li>Redistribute content from World's Finances</li>
      </ul>
      ...
      <p>
        ...
        World's Finances does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of World's Finances,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, World's Finances
      ...
      <p>
        World's Finances reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant World's Finances a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of World's Finances; and (d) the
      ...
      <p>
        ...
        e-mail to World's Finances. Please include your name, your organization
      ...
      <p>
        No use of World's Finances's logo or other artwork will be allowed for
      ...
      <a class="btn btn-info" href="registration" role="button">Back</a>
    </div>
  );
};

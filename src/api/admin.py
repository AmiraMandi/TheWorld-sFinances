...
from .models import db, User, Reader, News, Keyword, KeywordsFavorites, NewsFavorites, Advertisers, Widget, WidgetFavorites,SuggestionBox
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(SuggestionBox, db.session))
